...
import com.clerodri.horoscapp.databinding.ActivityHoroscopeDetailBinding
...
class HoroscopeDetailActivity : AppCompatActivity() {
            ...
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                horoscopeDetailViewModel.state.collect {
                    when (it) {
                        ...
                        is HoroscopeDetailState.Successs -> successState(it)
    ...
    private fun successState(state: HoroscopeDetailState.Successs) {
